...
class DeleteVoterDialog extends React.Component {
  ...
  render() {
    const { classes, openDialog, handleClickCloseDialog, voterToBeDeleted } = this.props
              ...
              return (
                <Grid item key={field.field} style={{width: '100%'}}> 
                  ...
                  >
                    ...
                    <Grid item xs={9}><Typography className={classes.fieldValue}>{voterToBeDeleted[field.field]}</Typography></Grid>
                  </Grid>
                </Grid>
              )  
            })}
